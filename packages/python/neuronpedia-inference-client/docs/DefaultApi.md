...
[**activation_topk_by_token_batch_post**](DefaultApi.md#activation_topk_by_token_batch_post) | **POST** /activation/topk-by-token-batch | For a given batch of prompts, get the top activating features at each token position for a single SAE.
...
# **activation_all_batch_post**
> ActivationAllBatchPost200Response activation_all_batch_post(activation_all_batch_post_request)
...
------------- | ------------- | ------------- | -------------
 **activation_all_batch_post_request** | [**ActivationAllBatchPostRequest**](ActivationAllBatchPostRequest.md)|  | 
...
# **activation_topk_by_token_batch_post**
> ActivationTopkByTokenBatchPost200Response activation_topk_by_token_batch_post(activation_topk_by_token_batch_post_request)
...
with neuronpedia_inference_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = neuronpedia_inference_client.DefaultApi(api_client)
    activation_topk_by_token_batch_post_request = neuronpedia_inference_client.ActivationTopkByTokenBatchPostRequest() # ActivationTopkByTokenBatchPostRequest | 

    try:
        # For a given batch of prompts, get the top activating features at each token position for a single SAE.
        api_response = api_instance.activation_topk_by_token_batch_post(activation_topk_by_token_batch_post_request)
        print("The response of DefaultApi->activation_topk_by_token_batch_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DefaultApi->activation_topk_by_token_batch_post: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **activation_topk_by_token_batch_post_request** | [**ActivationTopkByTokenBatchPostRequest**](ActivationTopkByTokenBatchPostRequest.md)|  | 
