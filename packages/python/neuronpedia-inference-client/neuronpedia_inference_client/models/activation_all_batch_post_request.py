...
class ActivationAllBatchPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["prompts", "model", "source_set", "selected_sources", "sort_by_token_indexes", "ignore_bos", "feature_filter", "num_results"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivationAllBatchPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivationAllBatchPostRequest from a dict"""
        if obj is None:
            return None
