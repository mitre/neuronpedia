...
class ActivationSingleBatchPost200Response(BaseModel):
    """
    Response for NPActivationBatchRequest. Contains the batch results of activation values and tokenized prompt.
    """ # noqa: E501
    results: List[ActivationSingleBatchPost200ResponseResultsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ActivationSingleBatchPost200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
