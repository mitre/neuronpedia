...
class ActivationTopkByTokenBatchPost200ResponseResultsInner(BaseModel):
    """
    ActivationTopkByTokenBatchPost200ResponseResultsInner
    """ # noqa: E501
    results: List[ActivationTopkByTokenPost200ResponseResultsInner]
    tokens: List[StrictStr]
    __properties: ClassVar[List[str]] = ["results", "tokens"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [ActivationTopkByTokenPost200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
