...
class ActivationTopkByTokenBatchPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["prompts", "model", "source", "top_k", "ignore_bos"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivationTopkByTokenBatchPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivationTopkByTokenBatchPostRequest from a dict"""
        if obj is None:
            return None
