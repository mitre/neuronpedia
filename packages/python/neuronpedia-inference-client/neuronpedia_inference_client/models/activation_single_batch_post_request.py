...
class ActivationSingleBatchPostRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["prompts", "model", "source", "index", "vector", "hook"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivationSingleBatchPostRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivationSingleBatchPostRequest from a dict"""
        if obj is None:
            return None
