import { MAX_EXPLANATION_SEARCH_RESULTS, searchExplanationsModelVec } from '@/lib/db/explanation';
...
export const POST = withOptionalUser(async (request: RequestOptionalUser) => {
  ...
  try {
    ...
    const result = await searchExplanationsModelVec(body.modelId, queryEmbeddingStr, body.offset || 0, request.user);
